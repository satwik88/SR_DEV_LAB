...
import { motion, useScroll, useTransform } from 'https://esm.sh/framer-motion@10';
        ...
        <div className="card-bottom-row">
          ...
          <div className="card-left-col">
            <div className="card-img-wrap">
              ...
              >
                <span style={{ fontSize: '4.5rem', fontWeight: 800, fontFamily: 'var(--mono)', opacity: 0.15, lineHeight: 1 }}>{number}</span>
                <span style={{ fontSize: '1.25rem', fontFamily: 'var(--sans)', marginTop: '0.5rem', fontWeight: 700, color: 'var(--proj-muted)' }}>{name}</span>
              </div>
            </div>
          </div>
          ...
          <div className="card-right-col">
            ...
            <div className="card-tech-section">
              <div className="card-tech-pills">
                {tech.map((pill, idx) => (
                  <span key={idx} className="card-tech-pill">{pill}</span>
                ))}
              </div>
            </div>
            ...
            <div className="card-actions">
              {github ? (
                ...
                <span className="private-repo-badge" title="This repository is private">
                  <svg viewBox="0 0 16 16" width="13" height="13" fill="currentColor">
                    <path fillRule="evenodd" d="M8 1a3.5 3.5 0 00-3.5 3.5V6H3.75A1.75 1.75 0 002 7.75v5.5C2 14.215 2.785 15 3.75 15h8.5A1.75 1.75 0 0014 13.25v-5.5A1.75 1.75 0 0012.25 6H11.5V4.5A3.5 3.5 0 008 1zm2 5V4.5a2 2 0 10-4 0V6h4zM3.75 7.5h8.5a.25.25 0 01.25.25v5.5a.25.25 0 01-.25.25h-8.5a.25.25 0 01-.25-.25v-5.5a.25.25 0 01.25-.25zM8 9a1 1 0 100 2 1 1 0 000-2z"></path>
                  </svg>
                  Private Repo
                </span>
              )}
